...
public class ItemEdit extends TestCase {
  ...
  public void testItemEdit() throws Exception {
    ...
    assertEquals("ui-button", driver.findElement(By.id("j_idt11:j_idt17:3:j_idt33")).getText());
    assertEquals("ui-button", driver.findElement(By.id("j_idt11:j_idt17:3:j_idt35")).getText());
    Thread.sleep(10000);
    driver.findElement(By.id("j_idt11:j_idt17:3:j_idt33")).click();
    Thread.sleep(10000);
    assertEquals("ui-button", driver.findElement(By.id("j_idt11:j_idt17:3:j_idt34")).getText());
    // ERROR: Caught exception [ERROR: Unsupported command [getTable | id=j_idt11:j_idt17:3:j_idt19.0.1 | ]]
    assertEquals("", driver.findElement(By.name("j_idt11:j_idt17:3:j_idt29")).getText());
    driver.findElement(By.name("j_idt11:j_idt17:3:j_idt29")).clear();
    driver.findElement(By.name("j_idt11:j_idt17:3:j_idt29")).sendKeys("New Example");
    driver.findElement(By.id("j_idt11:j_idt17:3:j_idt34")).click();
    assertEquals("New Example", driver.findElement(By.xpath("//table[@id='j_idt11:j_idt17:3:j_idt19']/tbody/tr/td[2]")).getText());
