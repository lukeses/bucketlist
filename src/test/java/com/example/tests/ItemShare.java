...
public class ItemShare extends TestCase {
  ...
  @Test
  public void testItemShare() throws Exception {
    ...
    driver.findElement(By.id("j_idt6:name")).clear();
    driver.findElement(By.id("j_idt6:name")).sendKeys("j.nowak@gmail.com");
    driver.findElement(By.id("j_idt6:pass")).clear();
    driver.findElement(By.id("j_idt6:pass")).sendKeys("trudn3h45l0");
    driver.findElement(By.id("j_idt6:j_idt11")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (isElementPresent(By.id("j_idt11"))) break; } catch (Exception e) {}
    ...
    //assertEquals("Welcome j.nowak@gmail.com! \nLog outAdd itemUsersUser panel \nIsc na piknik ui-button ui-button ui-button \n Finish task ui-button 0% \n \n ui-button \n \n \nZarobic milion dolarow. ui-button ui-button ui-button \n Finish task ui-button 0% \n \n ui-button \n \n \nKupic BMW. ui-button ui-button ui-button \n Finish task ui-button 0% \n \n ui-button", driver.findElement(By.id("j_idt11")).getText());
    assertEquals("Users", driver.findElement(By.id("j_idt11:j_idt15")).getText());
    ...
    assertEquals("Example", driver.findElement(By.xpath("//div[@id='j_idt12:j_idt13:3:j_idt24']/table/tbody/tr[2]/td[2]/span")).getText());
    assertEquals("add to my list", driver.findElement(By.xpath("(//a[contains(text(),'add to my list')])[4]")).getText());
    driver.findElement(By.xpath("(//a[contains(text(),'add to my list')])[4]")).click();
    driver.findElement(By.name("j_idt7:j_idt10")).clear();
    driver.findElement(By.name("j_idt7:j_idt10")).sendKeys("ExampleMy");
    driver.findElement(By.name("j_idt7:j_idt14")).click();
    assertEquals("ExampleMy", driver.findElement(By.xpath("//table[@id='j_idt11:j_idt17:3:j_idt19']/tbody/tr/td[2]")).getText());
    ...
    //assertEquals("Welcome kowal82@buziaczek.pl! \nLog outAdd itemUsersUser panel \nIsc do baru. ui-button ui-button ui-button \n Finish task ui-button 0% \n \n ui-button \n \n \nSamochód ui-button ui-button ui-button \n Finish task ui-button 0% \n \n ui-button \n \n \nZarobic milion dolarow. ui-button ui-button ui-button \n Finish task ui-button 0% \n \n ui-button \n \n \nExample ui-button ui-button ui-button \n Finish task ui-button 0% \n \n ui-button", driver.findElement(By.id("j_idt11")).getText());
    assertEquals("Example", driver.findElement(By.xpath("//table[@id='j_idt11:j_idt17:3:j_idt19']/tbody/tr/td[2]")).getText());
    Thread.sleep(10000);
    driver.findElement(By.id("j_idt11:j_idt17:3:j_idt35")).click();
    Thread.sleep(10000);
